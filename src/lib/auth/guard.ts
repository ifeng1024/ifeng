...
import { RoleCode, RoleLevel, CAN_MANAGE_CANTEEN, CAN_MANAGE_STALL, CAN_CREATE_COMPANY } from './constants';
...
export { CAN_CREATE_COMPANY, CAN_MANAGE_CANTEEN, CAN_MANAGE_STALL };
